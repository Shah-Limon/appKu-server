        ...
        app.put("/edit-banner/:id", async (req, res) => {
          ...
          const updatedDoc = {
            $set: {
              ...
              bannerImageTwo: updateBanner.bannerImageTwo,
    ...
    app.put("/edit-about-service/:id", async (req, res) => {
      ...
      const updatedDoc = {
        $set: {
          ...
          sliderImg: aboutUpdate.sliderImg,
          pointOne: aboutUpdate.pointOne,
          pointTwo: aboutUpdate.pointTwo,
          pointThree: aboutUpdate.pointThree,
          pointFour: aboutUpdate.pointFour,
          pointFive: aboutUpdate.pointFive,
          pointSix: aboutUpdate.pointSix,
        },
      };
...
app.put("/feature/:id", async (req, res) => {
  ...
  const updatedDoc = {
    $set: {
      ...
      btnUrl: feature.btnUrl,
      ImageBoxThree: feature.ImageBoxThree,
      ParaBoxThree: feature.ParaBoxThree,
      TitleBoxThree: feature.TitleBoxThree,
      ImageBoxTwo: feature.ImageBoxTwo,
      ParaBoxTwo: feature.ParaBoxTwo,
      TitleBoxTwo: feature.TitleBoxTwo,
      TitleBoxOne: feature.TitleBoxOne,
      ParaBoxOne: feature.ParaBoxOne,
      ImageBoxOne: feature.ImageBoxOne,
